...
func TestSpriteComponent(t *testing.T) {
	t.Run("Create New Sprite Component with all fields", func(t *testing.T) {
		sprite, _ := NewSprite("texture.png", "Atlas-1", "sprite-1", PrimitiveKindRectangle, geom.Vector2{X: 32, Y: 32}, 0, 0, true, nil)
	...
	t.Run("Create New Sprite with layer greater than 31", func(t *testing.T) {
		sprite, _ := NewSprite("texture.png", "", "", PrimitiveKindRectangle, geom.Vector2{X: 32, Y: 32}, 35, 0, true, nil)
	...
	t.Run("Create New Sprite with invalid primitive type", func(t *testing.T) {
		sprite, _ := NewSprite("texture.png", "", "", 99, geom.Vector2{X: 32, Y: 32}, 0, 0, true, nil)
		if sprite.Primitive != PrimitiveKindRectangle {
	...
	t.Run("Create New Sprite with atlasID but no regionName", func(t *testing.T) {
		_, err := NewSprite("texture.png", "Atlas-1", "", PrimitiveKindRectangle, geom.Vector2{X: 32, Y: 32}, 0, 0, true, nil)
		if err == nil {
	...
	t.Run("Create New Sprite with regionName but no atlasID", func(t *testing.T) {
		_, err := NewSprite("texture.png", "", "sprite-1", PrimitiveKindRectangle, geom.Vector2{X: 32, Y: 32}, 0, 0, true, nil)
		if err == nil {
